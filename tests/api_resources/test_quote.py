...
class TestQuote(object):
    ...
    def test_is_listable(self, request_mock):
        resources = stripe_sub5.Quote.list()
        request_mock.assert_requested("get", "/v1/quotes")
        assert isinstance(resources.data, list)
        assert isinstance(resources.data[0], stripe_sub5.Quote)

    def test_is_retrievable(self, request_mock):
        resource = stripe_sub5.Quote.retrieve(TEST_RESOURCE_ID)
        request_mock.assert_requested(
            "get", "/v1/quotes/%s" % TEST_RESOURCE_ID
        )
        assert isinstance(resource, stripe_sub5.Quote)

    def test_is_creatable(self, request_mock):
        resource = stripe_sub5.Quote.create(customer="cus_123")
    ...
    def test_is_modifiable(self, request_mock):
        resource = stripe_sub5.Quote.modify(
    ...
    def test_can_finalize_quote_classmethod(self, request_mock):
        resource = stripe_sub5.Quote.finalize_quote(TEST_RESOURCE_ID)
        request_mock.assert_requested(
            "post", "/v1/quotes/%s/finalize" % TEST_RESOURCE_ID
        )
        assert isinstance(resource, stripe_sub5.Quote)
    ...
    def test_can_cancel_classmethod(self, request_mock):
        resource = stripe_sub5.Quote.cancel(TEST_RESOURCE_ID)
        request_mock.assert_requested(
            "post", "/v1/quotes/%s/cancel" % TEST_RESOURCE_ID
        )
        assert isinstance(resource, stripe_sub5.Quote)
    ...
    def test_can_accept_classmethod(self, request_mock):
        resource = stripe_sub5.Quote.accept(TEST_RESOURCE_ID)
        request_mock.assert_requested(
            "post", "/v1/quotes/%s/accept" % TEST_RESOURCE_ID
        )
        assert isinstance(resource, stripe_sub5.Quote)
    ...
    def test_can_list_line_items(self, request_mock):
        resources = stripe_sub5.Quote.list_line_items(TEST_RESOURCE_ID)
        request_mock.assert_requested(
    ...
    def test_can_list_computed_upfront_line_items(self, request_mock):
        resources = stripe_sub5.Quote.list_computed_upfront_line_items(
            TEST_RESOURCE_ID
        )
        request_mock.assert_requested(
            "get",
    ...
    def test_can_pdf_classmethod(self, setup_upload_api_base, request_mock):
        stream = stripe_sub5.Quote.pdf(TEST_RESOURCE_ID)
        request_mock.assert_api_base(stripe_sub5.upload_api_base)
        request_mock.assert_requested_stream(
            "get", "/v1/quotes/%s/pdf" % TEST_RESOURCE_ID
        )
