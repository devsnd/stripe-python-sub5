...
import stripe_sub5
from stripe_sub5.six import python_2_unicode_compatible
...
class StripeError(Exception):
    ...
    def construct_error_object(self):
        ...
        return stripe_sub5.api_resources.error_object.ErrorObject.construct_from(
            self.json_body["error"], stripe_sub5.api_key
        )
