...
class MultipartDataGenerator(object):
    ...
    def add_params(self, params):
        ...
        params = dict(stripe_sub5.api_requestor._api_encode(params))

        for key, value in stripe_sub5.six.iteritems(params):
            if value is None:
                continue
            ...
            if hasattr(value, "read"):
                ...
                if hasattr(value, "name"):
                    ...
                    filename = stripe_sub5.six.text_type(value.name)
    ...
    def _write(self, value):
        if isinstance(value, stripe_sub5.six.binary_type):
            array = bytearray(value)
        elif isinstance(value, stripe_sub5.six.text_type):
