...
import stripe_sub5
from stripe_sub5 import oauth, six
from stripe_sub5 import util
from stripe_sub5.api_resources.abstract import CreateableAPIResource
from stripe_sub5.api_resources.abstract import DeletableAPIResource
from stripe_sub5.api_resources.abstract import ListableAPIResource
from stripe_sub5.api_resources.abstract import UpdateableAPIResource
from stripe_sub5.api_resources.abstract import nested_resource_class_methods
from stripe_sub5.six.moves.urllib.parse import quote_plus
...
class Account(
    ...
    def serialize(self, previous):
        ...
        for k, v in six.iteritems(self):
            if (
                k == "individual"
                and isinstance(v, stripe_sub5.api_resources.Person)
                and k not in params
            ):
